...
public class TripleProvider {
    ...
    public static void main(String[] args) throws InterruptedException {
        ServiceConfig<CallTripleService> serviceConfig = new ServiceConfig<>();
        serviceConfig.setInterface(CallTripleService.class);
        serviceConfig.setRef(new CallTripleServiceImpl());

        ApplicationConfig applicationConfig = new ApplicationConfig();
        applicationConfig.setName("test-dubbo");
        // Process  Multi Provider in one env
